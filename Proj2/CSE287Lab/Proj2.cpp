...
static void RenderSceneCB()
{
	...
	//Draw purple pyramid
	modelingTransformation = glm::translate(3.5f, -1.5f, -3.5f);
	pyramid.draw(color(0.8f, 0.0f, 0.8f, 1.0f));

	//Draw purple cube
	modelingTransformation = glm::translate(3.5f, -2.5f, -3.5f);
	cube.draw(color(0.8f, 0.0f, 0.8f, 1.0f));

	// Draw the green cube
	modelingTransformation = glm::translate(-0.5f, -2.5f, -0.5f);
	cube.draw(color(0.2f, 0.8f, 0.2f, 1.0f));
	...
	// Draw the red cube
	modelingTransformation = glm::translate(glm::vec3(0.0f, -2.5f, 0.0f));
	cube.draw(color(0.9f, 0.2f, 0.1f, 1.0f));

	// Draw the blue cube
	modelingTransformation = glm::translate(0.0f, -1.5f, 0.0f) * glm::rotate(glm::radians(45.0f), glm::vec3(0.0f, 1.0f, 0.0f));
...
void viewMenu(int value)
{
	...
	case(0) : 
		camera.setPositionDirectionUp(glm::vec3(0.0f, 0.0f, 12.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		viewingTransformation = camera.getViewingTransformation();
		break;

	case(1) :
		camera.setPositionDirectionUp(glm::vec3(0.0f, 0.0f, -15.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		viewingTransformation = camera.getViewingTransformation();
		break;

	case(2) :
		camera.setPositionDirectionUp(glm::vec3(30.0f, 30.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 1.0f, 0.0f));
		viewingTransformation = camera.getViewingTransformation();
		break;

	case(3) :
		camera.setPositionDirectionUp(glm::vec3(0.0f, 15.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(1.0f, 0.0f, -1.0f));
		viewingTransformation = camera.getViewingTransformation();
		break;
