...
QuadricSurface::QuadricSurface( const vec3 & position, const color & mat )
...
* intersection.
*/
HitRecord QuadricSurface::findClosestIntersection (const vec3 &rayOrigin, const vec3 &rayDirection)
{ 
	HitRecord hitRecord; 

	vec3 Ro = rayOrigin - center;
